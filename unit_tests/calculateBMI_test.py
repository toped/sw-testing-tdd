...
#test with integers
def test_example_1():
    assert calculateBMI(5, 3, 125) == "Your body mass index is: 22.67. You are of normal weight."
...
#test with floats    
def test_float():
    assert calculateBMI(4.0, 20.9, 130) == "Your body mass index is: 19.72. You are of normal weight."
